/* ════════════════════════════════════════════════
   ...
   Versioned assets: 2026-08-11-ROOT-ASSET-FIX
   ════════════════════════════════════════════════ */

// main.js lives in /js. Asset URLs MUST be root-relative; otherwise
// "css/visual-fixes.css" becomes /js/css/... and returns 404.
const ASSET_VERSION = '20260811-root-assets-3';
...
// Load the visual system after style.css so the redesign wins over legacy rules.
loadStylesheet('/css/visual-fixes.css');
loadStylesheet('/css/redesign.css');

// ── Official Lozartico logo ────────────────────
// Use the supplied logo directly in every page header.
